...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Libellum: Your Biblioteca</title>
                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <div class="flex lg:justify-center lg:col-start-2">
                            <img src="assets/img/book icon.png" style="width: 50px">
                        </div>
                        @if (Route::has('login'))
                        ...
                        <div class="grid gap-6 lg:gap-8">
                                    ...
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            ...
                                            <p class="mt-4 text-sm/relaxed">
                                                Libellum: Your Bibloteca is an online library for book enthusiast. It can help you manage your online book collection. With Libellum, you can easily keep track of your favourite reads and maintain a well-organized digital library hassle-free!
                                            </p>
                                        </div>
                                    </div>
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Book Management</h2>
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Featured Books</h2>
                            ...
                            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10">
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Login/Signup</h2>
